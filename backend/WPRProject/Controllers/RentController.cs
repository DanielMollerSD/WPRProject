    ...
    public class RentController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<object>>> GetAllRentRequests()
        {
            ...
            var rentRequests = rents.Select(rent => new
            {
                ...
                rent.StartDate,
                rent.EndDate,
                Vehicle = rent.Vehicle != null
                 ? new { rent.Vehicle.Id, rent.Vehicle.Brand, rent.Vehicle.Model }
                 : new { Id = 0, Brand = "Unknown", Model = "Unknown" },
                ...
                TotalPrice = rent.Vehicle != null && rent.StartDate != default && rent.EndDate != default
                 ? (rent.EndDate - rent.StartDate).Days * rent.Vehicle.Price
                 : 0,
                rent.Status
            }).ToList();
